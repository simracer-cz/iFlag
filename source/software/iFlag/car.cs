...
namespace iFlag
{
    public partial class mainForm : Form
    {
        ...
        private void getCarDetails()
        {
            ...
            distanceToPitStall = (flip + pitStallLapPct - carLapPct) * trackLength;

            onPitRoad = (bool)sdk.GetData("OnPitRoad");
            onPitExitRoad = !onPitRoad && hasPitted && carSurface == irsdk_AproachingPits && distanceToPitStall < 0;
            onPitEntryRoad = !onPitRoad && carSurface == irsdk_AproachingPits && distanceToPitStall > 0;
